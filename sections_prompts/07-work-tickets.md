...
**Prompt 1: Prompt para crear comando y skill para crear tickets (Claude Opus 4.8)**
Eres un experto product owner y gestión de proyectos. En @system_architecture/user_stories_view/ estan definidas 4 historias
de usuario junto con sus prototipos de interfaz que necesitamos desglosar en issues pequeÃ±as de github divididas entre
