...
**Prompt 5: Prompt para crear el subagente, skill y reglas de despliegue con GitHub Actions a EC2 por SSH (Claude Opus 4.8)**
Eres un experto DevSecOps experto especializado en Github Actions y en AWS. Quiero que generes un subagente, una skill y las reglas de buenas prácticas/seguridad en la carpeta @.claude para trabajar con Github Actions y hacer despliegues de aplicaciones en un servidor EC2 de AWS a través de SSH usando un fichero de clave privada. Restringue tus conocimientos a las documentaciones oficiales de Github Actions y EC2 AWS. También puedes buscar información en fuentes reconocidas donde haya recomendaciones de como hacer este proceso. No tomes decisiones por ti mismo ni inventes nada que no esté documentado. Pregunta cualquier decisión que tengas que tomar.
