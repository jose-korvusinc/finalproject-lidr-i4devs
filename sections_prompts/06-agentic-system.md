...
**Prompt 1: Metaprompt para crear un prompt que genere las reglas de Angular 22 (Claude Opus 4.8)**
...
Prompt generado: [Reglas de Angular 22 para `.claude/rules`](generated_prompts/angular-22-rules-generation-prompt.md)
